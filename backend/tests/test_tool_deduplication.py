...
@patch("deerflow.tools.tools.is_host_bash_allowed", return_value=True)
@patch("deerflow.tools.tools.reset_deferred_registry")
def test_subagent_async_only_tool_gets_sync_wrapper(mock_reset, mock_bash, mock_cfg):
...
@patch("deerflow.tools.tools.is_host_bash_allowed", return_value=True)
@patch("deerflow.tools.tools.reset_deferred_registry")
def test_acp_async_only_tool_gets_sync_wrapper(mock_reset, mock_bash, mock_cfg):
